...
export async function generateMetadata() {
  ...
  return buildMetadata({ title: c.title, description: c.meta, path: '/terms' });
}
...
export default async function TermsPage() {
  ...
  return (
    <article className="container-page py-12 sm:py-16 max-w-3xl">
      ...
      <style>{`
        .prose-content h2 { font-family: Georgia, serif; font-size: 1.5rem; color: #2A2A33; margin-top: 1.75rem; margin-bottom: 0.5rem; }
